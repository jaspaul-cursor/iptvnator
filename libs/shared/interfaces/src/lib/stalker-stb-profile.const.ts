 ...
 * but only as one coherent MAG254: the model, firmware, hardware revision and
...
export const STALKER_STB_PROFILE_PARAMS: Readonly<Record<string, string>> =
    Object.freeze({
        /** Firmware banner a MAG254 reports verbatim. */
        ver:
            'ImageDescription: 0.2.18-r23-pub-254; ImageDate: Wed Aug 29 10:49:26 EEST 2018; PORTAL version: 5.6.1; API Version: JS API version: 328; STB API version: 134; Player Engine version: 0x566',
